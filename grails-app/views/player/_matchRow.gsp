<tr>
    ...
    <g:if test="${playerId.equals(match.player1.id)}">
    ...
    <g:else>
        <td style="text-align:right"><g:link controller="player" action="show" id="${match.player2.id}">${match.player2}</g:link> <cw:ratingChangeBadge rating="${match.player2rating}" ratingChange="${match.player2ratingChange}" /></td>
        <td><cw:ratingChangeBadge rating="${match.player1rating}" ratingChange="${match.player1ratingChange}" /> <g:link controller="player" action="show" id="${match.player1.id}">${match.player1}</g:link></td>
    </g:else>
